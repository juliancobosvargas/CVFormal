<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="frmCorreo.aspx.cs" Inherits="CapaPresentacion.Privado.frmCorreo" %>
            ...
            <div class="container-fluid">
                <div class="row">
                    <div class="col-md-3">
                        ...
                        <asp:Button ID="btnCorreo" runat="server" Text="Correo" class="btn btn-success" OnClick="btnCorreo_Click"/>
