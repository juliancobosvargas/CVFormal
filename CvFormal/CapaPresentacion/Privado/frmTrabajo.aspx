<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="frmTrabajo.aspx.cs" Inherits="CapaPresentacion.Privado.frmTrabajo" %>
            ...
            <div class="container-fluid">
                <div class="row">
                    <div class="col-md-3">
                        ...
                        <asp:Button ID="btnTrabajo" runat="server" Text="Trabajo" class="btn btn-success" OnClick="btnTrabajo_Click"/>
