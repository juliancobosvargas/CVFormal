<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="frmHabilidad.aspx.cs" Inherits="CapaPresentacion.Privado.frmHabilidad" %>
            ...
            <div class="container-fluid">
                <div class="row">
                    <div class="col-md-3">
                        ...
                        <asp:Button ID="btnHabilidad" runat="server" Text="Habilidad" class="btn btn-success" OnClick="btnHabilidad_Click"/>
