<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="frmTelefono.aspx.cs" Inherits="CapaPresentacion.Privado.frmTelefono" %>
            ...
            <div class="container-fluid">
                <div class="row">
                    <div class="col-md-3">
                        ...
                        <asp:Button ID="btnTelefono" runat="server" Text="Telefono" class="btn btn-success" OnClick="btnTelefono_Click"/>
