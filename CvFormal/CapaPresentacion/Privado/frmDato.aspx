<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="frmDato.aspx.cs" Inherits="CapaPresentacion.Privado.frmDato" %>
            ...
            <div class="container-fluid">
                <div class="row">
                    <div class="col-md-3">
                        ...
                        <asp:Button ID="btnDato" runat="server" Text="Dato" class="btn btn-success" OnClick="btnDato_Click"/>
